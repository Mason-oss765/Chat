...
class MainWindow(CTk):
    def __init__(self):
        ...
        # main
        self.chat_field = CTkScrollableFrame(self, fg_color="green"
    ...
    def toggle_show_menu(self):
        if self.is_show_menu:
            ...
            self.entry.pack()
            self.save_name_button = CTkButton(self.menu_frame, text="Save", command=self.save_name, fg_color="#cc99ff", hover_color="#b380f0", corner_radius=10, text_color="white")
